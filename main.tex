...
To investigate the skill of the individual models, decadal hindcasts were created.

\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{plots/nao_ensemble_mean_and_individual_members_subplots.png}
    \caption{Raw ensemble output for each of the 12 models used in the multi-model ensemble mean.}
